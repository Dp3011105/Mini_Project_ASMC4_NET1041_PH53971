...
namespace Mini_Project_ASMC4_NET1041_PH53971.Controllers
{
    public class NguoiDungsController : Controller
    {
        ...
        public NguoiDungsController(MiniProjectAsmc4Net1041Ph53971Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MaNguoiDung,Ten,MatKhau,Email,SoDienThoai,VaiTro,NgaySinh,TrangThai")] NguoiDung nguoiDung)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaNguoiDung,Ten,MatKhau,Email,SoDienThoai,VaiTro,NgaySinh,TrangThai")] NguoiDung nguoiDung)
        {
